...
| 文件 | 目录 | 产出人 | 说明 |
|------|------|--------|------|
| [七份周报执行效率优化方案](engineering/2026-09-16-weekly-efficiency-optimization-design.md) | engineering | 小帅+泰山+黄山 | 基于资本周报3小时28分实测及七任务当前配置，设计冻结前格式/路径检查、精确失效边界、紧凑账本、中间交接整合与阶段观测；保留全部研究与语义/发布验收，仅方案归档，未修改生产规则。 |
