...
> **研究边界**：14天内旧材料只作背景，不冒充本周动态。事实、公司主张与研究判断分开；融资额、估值、客户与经营数据优先采用一级来源并交叉验证。

---

## 一、本周总判断：资本从“买模型故事”转向“买控制点”
...
本期四线共完成约50个对象的初始扫描，合并去重后保留26个候选；四线证据账本记录约70条来源，完整阅读正文超过50份，覆盖公司/投资方公告、政府与监管原文、可靠媒体、技术与产品页。母稿形成前另对16项核心事实做URL复核，包括OpenRouter、Callosum、Stability AI、Rillet、Network Bio、Ours Privacy、小鹏、Gatik、北京机器人政策、英国AI硬件计划和欧盟AI法案。

**高确定性**：交易双方或公司/政府正式公告、且有独立正文交叉；如OpenRouter交易成立、Stability融资、小鹏融资、欧盟AI法案时间表。  
**中确定性**：公司披露但缺审计或客户独立证言；如Network Bio合同额、Gatik合同收入、中数睿智经营指标。  
**低确定性**：匿名知情人士、未交割融资、媒体估值；如OpenRouter交易价、General Intuition拟融资。

主要缺口：绝大多数私营公司不披露净留存、流失率、ARR绝对值、毛利、推理成本与客户级cohort；部分Reuters、Bloomberg、SEC和BusinessWire页面受访问限制；拉美、非洲、中东在严格窗口内未检出达到“正文+商业证据”门槛的强事件；“未发现”不等于绝对不存在。
